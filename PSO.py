...
import object_track_invariant #import compute_fitness_score
...
class PKTracker(object):
    ...
    def compute_fitness_value( self, image, forests, classifier, fixed_shape ):
        ...
        self._score_ = object_track_invariant.compute_fitness_score(classifier, forests, image, patch_data, fixed_shape)
        # print(self._score_)
